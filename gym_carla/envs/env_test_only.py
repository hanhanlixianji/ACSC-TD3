...
class CarlaEnv(gym.Env):
  ...
  def _get_reward(self):
    ...
    # r = 20_0000*r_collision + lspeed_lon + r_fast + 20_0000*r_out + r_steer*5 + 0.2*r_lat - 0.1
    r = 20_0000*r_collision + lspeed_lon + r_fast + 20_0000*r_out + r_steer*5 + 0.2*r_lat
